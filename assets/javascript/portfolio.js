...
$(document).ready(() => {
  const links = [
    {
    name: 'discord',
    link: 'https://discordapp.com/users/265596002306621440'
  },
    {
	  name: 'telegram',
	  link: 'https://t.me/fair_s'
	},
    {
      name: 'twitter',
      link: 'https://twitter.com/SincerelyFair',
    },
    {
      name: 'github',
      link: 'https://github.com/SincerelyFair',
    },
  ];
...
writeLine(["> Granting access to <span style='font-size: 14px; color: #ff91a4;'>[fairs.cf]</span>....", `> Access granted! <span style='font-size: 14px; color: #ff91a4;'>[completed]</span>`], 45, () => {
